   ...
   <div class="wrapper">
      <nav class="main-header navbar navbar-expand navbar-light">
         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mt-3">
               <a class="nav-link" data-widget="fullscreen" href="{{ route('instructor.instructorLogout') }}">
     ...
     <div class="sidebar">
        <nav class="mt-2">
           <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
              ...
              <li class="nav-item">
                <a href="/instructor/{{ Session::get('sessionInstructor') }}" class="nav-link">
             ...
             <li class="nav-item">
                <a href="/instructor/profile/{{ Session::get('sessionInstructor') }}" class="nav-link">
                   <img src="../asset/img/complaint.png" width="30">
                   <p>
                      Profile
                   </p>
