   ...
   <div class="wrapper">
      <nav class="main-header navbar navbar-expand navbar-light">
         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
               <a class="nav-link" data-widget="fullscreen" href="{{ route('secretery.secreteryLogout') }}">
         ...
         <div class="sidebar">
            <nav class="mt-2">
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                     <a href="/secretery/secretery-log" class="nav-link">
                  ...
                  <li class="nav-item">
                     <a href="/secretery/secretery-case" class="nav-link">
