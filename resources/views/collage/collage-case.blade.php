                            ...
                            <div class="form">
                                ...
                                <div class="column">
                                    <div class="input-box">
                                        ...
                                        <input type="text" value="{{ $cases->username }}"  readonly/>
                                    </div>
                                    <div class="input-box">
                                            <label>ID No</label>
                                ...
                                <form action="response/{{ $cases->token }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" name="studentResponse" value="{{ $cases->token }}">


                                      <div class="form-floating mb-3">
                                        <textarea class="form-control"   name="response" placeholder="Leave a response here" id="floatingTextarea2" style="height: 100px"></textarea>
                                      ...
                                      @error('response')
                                       ...
                                       @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" list="browsers" name="forward" id="browser">
                                            <datalist id="browsers">
                                                <option value="Registral">
                                                <option value="Ac">
                                                <option value="Chair">
                                                <option value="Insructor">
