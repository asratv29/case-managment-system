      ...
      <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0"><img src="../asset/img/user.png" width="40">Instructor</h1>
                  </div>
                  <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
       <div class="modal-content">
          <div class="modal-body text-center">
              <form action="/admin/i/store" method="post">
                       ...
                       <div class="row">
                          <div class="col-md-12">
                             <div class="card-header">
                                <h5><img src="../asset/img/user.png" width="40"> Instructor User Information</h5>
                             </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                       <label class="float-left">Assing chair</label>
                                       <select  class="form-control" name="chairid" required>
             ...
             <table id="example1" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-sm btn-success" href="/admin/i/{{ $user->id }}/update"><i
                                class="fa fa-user-edit"></i> update</a>
                        <a class="btn btn-sm btn-danger" href="/admin/i/{{ $user->id }}"><i
