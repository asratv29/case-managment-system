      ...
      <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0"><img src="../asset/img/user.png" width="40">Registral</h1>
                  </div>
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Registral</li>
                     </ol>
                  </div><br>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
       <div class="modal-content">
          <div class="modal-body text-center">
              <form action="/admin/s/registrar" method="post">
                       ...
                       <div class="row">
                          <div class="col-md-12">
                             <div class="card-header">
                                <h5><img src="../asset/img/user.png" width="40">Registral Information</h5>
                             </div>
                             <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                   <div class="form-group">
                                      ...
                                      <select name="role" class="form-control">
                                         <option value="Registral" selected>Registral</option>
            ...
            <table id="example1" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-sm btn-success" href="/admin/r/{{ $user->id }}/update" ><i
                                class="fa fa-user-edit"></i> update</a>
                        <a class="btn btn-sm btn-danger" href="/admin/r/{{ $user->id }}/delete" data-toggle="mmodal" data-target="#delete"><i
     ...
     <div class="modal-content">
        <div class="modal-body text-center">
           ...
           <div class="m-t-20">
              ...
              <a href="/admin/r/{{ $user->id }}/delete" class="btn btn-danger" >Delete</a>
           </div>
        </div>
     </div>
    </div>
