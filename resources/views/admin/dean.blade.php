      ...
      <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0"><img src="../asset/img/user.png" width="40">Dean</h1>
                  </div>
                  <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
       <div class="modal-content">
          <div class="modal-body text-center">
              <form action="/admin/d/store" method="post">
                       ...
                       <div class="row">
                          <div class="col-md-12">
                             <div class="card-header">
                                <h5><img src="../asset/img/user.png" width="40"> Dean User Information</h5>
                             </div>
                             <div class="row">
                                <div class="col-md-4">
             ...
             <table id="example1" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-sm btn-success" href="/admin/d/{{ $user->id }}/update"><i
                                class="fa fa-user-edit"></i> update</a>
                        <a class="btn btn-sm btn-danger" href="/admin/d/{{ $user->id }}/delete" data-toggle="modasl" data-target="#deletde"><i
