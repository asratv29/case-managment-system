      ...
      <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0"><img src="../asset/img/user.png" width="40">Student</h1>
                  </div>
                  <div class="col-sm-6">
          ...
          @endif
          @error('email')
          <p class="text-warning text-cente">{{ $message }}</p>
      @enderror
      @error('username')
      <p class="text-warning text-cente">{{ $message }}</p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
       <div class="modal-content">
          <div class="modal-body text-center">
              <form action="/admin/stud/store" method="post">
                       ...
                       <div class="row">
                          <div class="col-md-12">
                             <div class="card-header">
                                <h5><img src="../asset/img/user.png" width="40"> Studddent User Information</h5>
                             </div>
                             <div class="row">
                                <div class="col-md-4">
            ...
            <table id="example1" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($user->status == 0)
                                    <span class="badge bg-warning">Inactivated</span>
                            @endif
                            @if($user->status > 0)
                        ...
                        <td class="text-center">
                            @if($user->status == 0)
                                <a href="/admin/stud/enable/{{ $user->id }}/account" class="btn btn-sm btn-success">enable</a>
                            @endif
                            @if($user->status  > 0)
                               <a href="/admin/stud/disable/{{ $user->id }}/account" class="btn btn-sm btn-warning">disble</a>
                            @endif
                            <a class="btn btn-sm btn-success" href="/admin/stud/{{ $user->id }}/update"><i
